"""social — the Social Calendar workflow (Content Hub workflow #1).
  ...
  edit_ops   direct in-place cell edits + bulk row appends to the living sheet;
             describe the sheet's columns/rows (look before you write)
